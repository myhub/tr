...
#### 为什么开发tr？
我刚开发tr时，网上只有[chineseocr](https://github.com/chineseocr/chineseocr)、 [Tesseract OCR](https://github.com/tesseract-ocr/tesseract)等少数开源OCR。tr发布后，又诞生了几款优秀的开源OCR，tr也基本上完成了自己的使命，会转为一个研究型项目，更追求技术的先进性而不是实用性。
