...
如果您要识别的图片类似于以下图片，使用现有OCR无法解决时，那么多行CRNN将是您的最好选择之一。
<div>
<img width="150px" src="crnn_for_text_with_multiple_lines/imgs/test1.png" style="float:left;width:150px;" />
<img width="150px" src="crnn_for_text_with_multiple_lines/imgs/test2.png" style="float:left;width:150px;" />
<img width="150px" src="crnn_for_text_with_multiple_lines/imgs/test3.jpg" style="float:left;width:150px;" />
<img width="150px" src="crnn_for_text_with_multiple_lines/imgs/test4.png" style="float:left;width:150px;" />
<img width="150px" src="crnn_for_text_with_multiple_lines/imgs/test5.jpg" style="float:left;width:150px;" />
<img width="150px" src="crnn_for_text_with_multiple_lines/imgs/test6.png" style="float:left;width:150px;" />
<img width="150px" src="crnn_for_text_with_multiple_lines/imgs/test7.jpg" style="float:left;width:150px;" />
<img width="150px" src="crnn_for_text_with_multiple_lines/imgs/test8.png" style="float:left;width:150px;" />
</div>
